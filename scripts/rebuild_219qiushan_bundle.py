...
SOURCE_PDF = ROOT / "examples" / "papers" / "219qiushan.pdf"
BUNDLE = ROOT / "output" / "papers" / "219qiushan"
...
def main() -> None:
    ...
    render_crop(doc, 1, (0.10, 0.04, 0.90, 0.33), BUNDLE / "assets" / "header" / "paper-header.png")

    crop_specs = [
        ("fig-001", "figure", 2, (0.18, 0.54, 0.79, 0.88), "Fig. 1 simulation setup, dislocation network, and hydrogen injection"),
        ("fig-002", "figure", 3, (0.18, 0.61, 0.79, 0.88), "Fig. 2 temperature history, three-stage uptake snapshots, and H layer volume evolution"),
        ("fig-003", "figure", 5, (0.18, 0.10, 0.79, 0.52), "Fig. 3 hydrogen uptake and hydrogen uptake rate under different conditions"),
        ("fig-004", "figure", 6, (0.18, 0.41, 0.79, 0.76), "Fig. 4 NARX-augmented Transformer forecasting architecture"),
        ("fig-005", "figure", 7, (0.18, 0.19, 0.79, 0.36), "Fig. 5 predicted versus true HUR and residual histogram"),
        ("fig-006", "figure", 7, (0.18, 0.57, 0.79, 0.78), "Fig. 6 ML-predicted HUR time history curves"),
        ("fig-007", "figure", 8, (0.18, 0.29, 0.79, 0.50), "Fig. 7 SHAP and DeepLIFT interpretability analysis"),
    ]
    ...
    metadata = {
        ...
        "title": "Interpretable Molecular Dynamics-Machine Learning Framework for Hydrogen Uptake Mechanism in Magnesium",
        "author": "Qiushan Huang; Zhi-Qian Zhang; Yue Cui",
        "journal": "Not stated in source PDF",
    ...
    asset_report = {
        ...
        "warnings": [],
        "notes": [
            "The source manuscript presents seven numbered figures as the core visual evidence.",
            "No standalone tables or displayed formulas are used as primary evidence blocks in the paper.",
        ],
    }
    ...
    manifest = {
        ...
        "summary": {"figure_count": 7, "table_count": 0, "formula_count": 0},
        "assets": assets,
        "global_flags": [],
    }
    ...
    report = {
        ...
        "paper_slug": "219qiushan",
        "summary_path": "output/papers/219qiushan/summary.md",
        "missing_sections": [],
        "missing_assets": [],
        "unreadable_regions": [],
        "notes": [
            "The validation run generated a header crop and seven figure assets.",
            "The paper's main evidence is carried by figures and narrative analysis rather than standalone tables or displayed formulas.",
        ],
        "errors": [],
    }
